...
$opt_gal_client_id 		= '813763397552-fqdmsqui6bj84r98r3qmmat1tgdmbj2m.apps.googleusercontent.com';
$opt_gal_client_secret	= 'A6KjJL-GUQaQALynfPNKEAfM';
$opt_gal_redirect_uri 	= 'http://dilbert.ajency.in/oauth2callback';
$opt_gal_domain 		= 'ajency.in';
...
function gal_set_auth_defaults()
{
	...
	?>
	  <script type="text/javascript">
	  	var WPSITEURL	= 	'<?php echo site_url()."/members/";?>';
...
do_action('login_form');//to append google sign in button to login form 
/**
